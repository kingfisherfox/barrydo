...
echo "    $URL"
echo ""
echo "  Your API key — SAVE THIS NOW. It is your PASSWORD to log into"
echo "  the web app AND the token your agents use. It cannot be retrieved"
echo "  later without generating a new one (npx wrangler secret put API_KEY):"
echo "    $API_KEY"
echo ""
